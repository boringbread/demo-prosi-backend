...
class C_Tabel1 extends CI_Controller
{
    ...
    public function loadView()
    {
        ...
        $data['pendidikan'] = $this->db->query("EXEC Tabel1_KerjasamaPendidikan")->result_array();
        $data['penelitian'] = $this->db->query("EXEC Tabel1_KerjasamaPenelitian")->result_array();
        $data['pkm'] = $this->db->query("EXEC Tabel1_KerjasamaPKM")->result_array();
