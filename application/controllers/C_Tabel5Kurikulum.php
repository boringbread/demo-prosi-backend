...
class C_Tabel5Kurikulum extends CI_Controller
{
    ...
    public function loadView()
    {
        ...
        $data['table4'] = $this->db->query("EXEC Tabel5a_Kurikulum")->result_array();
        $this->db->query("SET NOCOUNT OFF");

        $this->load->view('layout/V_Require');
        $this->load->view('layout/V_Header');
        $this->load->view('pages/kriteria5/V_Tabel5Kurikulum', $data);
    ...
    public function getBukti($idPenelitian)
    {
        ...
        $this->load->model('M_Tabel5Kurikulum', 'M_Tabel5');
