...
class C_Tabel5Integrasi extends CI_Controller
{
    ...
    public function loadView()
    {
        ...
        $data['table5'] = $this->db->query("EXEC Tabel5b_IntegrasiKegiatanPenelitianPkMV2")->result_array();

        $this->db->query("SET NOCOUNT OFF");

        $this->load->view('layout/V_Require');
        $this->load->view('layout/V_Header');
        $this->load->view('pages/kriteria5/V_Tabel5Integrasi', $data);
