...
class C_Tabel8Prestasi extends CI_Controller
{
    ...
    public function loadView()
    {
        ...
        $data['akademik'] = $this->db->query("EXEC Tabel8_PrestasiAkademik")->result_array();
        $data['nonakademik'] = $this->db->query("EXEC Tabel8_PrestasiNonAkademik")->result_array();
        $this->db->query("SET NOCOUNT OFF");

        $this->load->view('layout/V_Require');
        $this->load->view('layout/V_Header');
        $this->load->view('pages/kriteria8/V_Tabel8Prestasi', $data);
    ...
    public function getBukti($idPenelitian)
    {
        ...
        $this->load->model('M_Tabel8Prestasi', "M_Tabel8");
